...
const api: IpcApi = {
  ...
  listCanvasLayers: () => ipcRenderer.invoke(IpcChannel.listCanvasLayers),
  listCanvasLayerUsage: () => ipcRenderer.invoke(IpcChannel.listCanvasLayerUsage),
  createCanvasLayer: (name) => ipcRenderer.invoke(IpcChannel.createCanvasLayer, name),
  renameCanvasLayer: (id, name) => ipcRenderer.invoke(IpcChannel.renameCanvasLayer, id, name),
  reorderCanvasLayers: (ids) => ipcRenderer.invoke(IpcChannel.reorderCanvasLayers, ids),
  inspectCanvasLayerDeletion: (id) => ipcRenderer.invoke(IpcChannel.inspectCanvasLayerDeletion, id),
  deleteCanvasLayerAndMerge: (id) => ipcRenderer.invoke(IpcChannel.deleteCanvasLayerAndMerge, id),
